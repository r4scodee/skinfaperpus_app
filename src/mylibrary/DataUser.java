...
public class DataUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_data_user.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                tbl_data_userAncestorAdded(evt);
            }
        ...
        jScrollPane1.setViewportView(tbl_data_user);
        if (tbl_data_user.getColumnModel().getColumnCount() > 0) {
            tbl_data_user.getColumnModel().getColumn(0).setResizable(false);
            tbl_data_user.getColumnModel().getColumn(1).setResizable(false);
            tbl_data_user.getColumnModel().getColumn(2).setResizable(false);
            tbl_data_user.getColumnModel().getColumn(3).setResizable(false);
        }
    ...
    private void tbl_data_userAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_tbl_data_userAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_tbl_data_userAncestorAdded
